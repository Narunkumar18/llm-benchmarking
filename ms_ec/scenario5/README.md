# Scenario 5: gRPC Microservices E-Commerce System
...
- `ms_sc5_parallel_sequential.txt` - Parallel orders, sequential workflow
- `ms_sc5_parallel_parallel.txt` - Parallel orders, parallel workflow
- `ms_sc5_sequential_sequential.txt` - Sequential orders, sequential workflow
- `ms_sc5_sequential_parallel.txt` - Sequential orders, parallel workflow
...
Created for LLM benchmarking research - Scenario 5: gRPC Microservices Implementation
